...
class Agenda extends Component {
  createSessionList = sessions => {
    return sessions.map(session => {
      return <ScheduleTile key={session.id} id={session.id} type={session.meta.type} title={session.title} venue={session.meta.venue} tags={session.topics}/>
    });
  };
  showSpinner = () => {
